            ...
            >
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 sm:gap-10">
                  ...
                  <Dialog open={isAskQuestionModalOpen} onOpenChange={setIsAskQuestionModalOpen}>
                    ...
                    />
                    <DialogContent className="max-w-[95vw] w-full h-[85dvh] md:h-[85dvh] overflow-y-auto overscroll-contain bg-background rounded-[2rem] sm:rounded-[3rem] border-none shadow-3xl p-8 sm:p-12">
                      <DialogHeader>
